...
# these details match up with records in test delius
su_details = {
    'X388807': {
        'title': 'Mr',
        'firstName': 'Alex',
        'lastName': 'River',
        'dateOfBirth': datetime.date(1989, 2, 10),
        'gender': 'Male',
        'ethnicity': 'Mixed: White and Black African',
        'preferredLanguage': 'English',
        'religionOrBelief': 'Hare Krishna',
        'disabilities': None,
    },
    'X390177': {
        'title': 'Ms',
        'firstName': 'Norina',
        'lastName': 'Loxley',
        'dateOfBirth': datetime.date(1978, 6, 3),
        'gender': 'Female',
        'ethnicity': None,
    ...
    'X390224': {
        ...
        'firstName': 'Ash',
        'lastName': 'Porter',
        'dateOfBirth': datetime.date(1970, 9, 5),
        'gender': 'Female',
        'ethnicity': None,
        'preferredLanguage': None,
        'religionOrBelief': None,
    ...
    'X390436': {
        ...
        'firstName': 'Jo',
        'lastName': 'Nile',
        'dateOfBirth': datetime.date(1979, 3, 11),
        'gender': 'Female',
        'ethnicity': None,
        'preferredLanguage': None,
        'religionOrBelief': None,
    ...
    'X390445': {
        ...
        'firstName': 'Rajiv',
        'lastName': 'Merced',
        'dateOfBirth': datetime.date(1991, 9, 14),
        'gender': 'Male',
        'ethnicity': None,
        'preferredLanguage': None,
        'religionOrBelief': None,
    ...
    'X390450': {
        ...
        'firstName': 'Adeel',
        'lastName': 'Mekong',
        'dateOfBirth': datetime.date(1982, 2, 10),
        'gender': 'Male',
        'ethnicity': None,
        'preferredLanguage': None,
        'religionOrBelief': None,
    ...
    'X390454': {
        ...
        'firstName': 'Teegan',
        'lastName': 'Clyde',
        'dateOfBirth': datetime.date(1986, 5, 12),
        'gender': 'Female',
        'ethnicity': None,
        'preferredLanguage': None,
        'religionOrBelief': None,
