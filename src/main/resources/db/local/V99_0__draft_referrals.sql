...
insert into service_user (referral_id, address, crn, disabilities, dob, ethnicity, title, first_name, last_name, needs, nomis_number, other_names, pnc_number, preferred_language, religion_or_belief, sex, sexual_orientation)
values ('1219a064-709b-4b6c-a11e-10b8cb3966f6', 'Flat 2, 27 Test Walk, SY16 1AQ - Private rental', 'X123456', 'Autism spectrum condition', TO_DATE('1980-08-10', 'YYYY-MM-DD'), 'White British', 'Mr', 'Alex', 'River', null, '0203394', 'Shorty', '2014/1234786A', 'English', 'None', 'MALE', 'Heterosexual');
