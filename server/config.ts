...
export default {
  ...
  dashboards: {
    ...
    serviceProvider: {
      ...
      myCases: Number(get('SP_MY_CASES_PAGE_SIZE', '1')),
      openCases: Number(get('SP_OPEN_CASES_PAGE_SIZE', '1')),
      unassignedCases: Number(get('SP_UNASSIGNED_CASES_PAGE_SIZE', '1')),
      completedCases: Number(get('SP_COMPLETED_PAGE_SIZE', '1')),
    },
  },
