...
export default class EditOasysRiskInformationView {
  ...
  private readonly sentOasysRiskInformation: SentOasysRiskInformation | null
  ...
  constructor(private readonly presenter: EditOasysRiskInformationPresenter) {
    ...
    this.sentOasysRiskInformation = presenter.sentOasysRiskInformation
  }
  ...
  private get whoIsAtRiskTextareaArgs(): TextareaArgs {
    ...
    const whoIsAtRisk = this.sentOasysRiskInformation?.riskSummaryWhoIsAtRisk || oasysRiskInfoText
    return {
      name: 'who-is-at-risk',
      id: 'who-is-at-risk',
      label: {},
  ...
  private get natureOfRiskTextareaArgs(): TextareaArgs {
    ...
    const natureOfRisk = this.sentOasysRiskInformation?.riskSummaryNatureOfRisk || oasysRiskInfoText
    return {
      name: 'nature-of-risk',
      id: 'nature-of-risk',
      label: {},
  ...
  private get riskImminenceTextareaArgs(): TextareaArgs {
    ...
    const riskImminence = this.sentOasysRiskInformation?.riskSummaryRiskImminence || oasysRiskInfoText
    return {
      name: 'risk-imminence',
      id: 'risk-imminence',
      label: {},
  ...
  private get riskToSelfSelfHarmTextareaArgs(): TextareaArgs {
    ...
    const selfHarm = this.sentOasysRiskInformation?.riskToSelfSelfHarm || oasysRiskInfoText
    return {
  ...
  private get riskToSelfSuicideTextareaArgs(): TextareaArgs {
    ...
    const suicide = this.sentOasysRiskInformation?.riskToSelfSuicide || oasysRiskInfoText
    return {
  ...
  private get riskToSelfHostelSettingTextareaArgs(): TextareaArgs {
    ...
    const hostelSetting = this.sentOasysRiskInformation?.riskToSelfHostelSetting || oasysRiskInfoText
    return {
  ...
  private get riskToSelfVulnerabilityTextareaArgs(): TextareaArgs {
    ...
    const vulnerability = this.sentOasysRiskInformation?.riskToSelfVulnerability || oasysRiskInfoText
    return {
  ...
  private get additionalInformationTextareaArgs(): TextareaArgs {
    ...
    const additionalInformation = this.sentOasysRiskInformation?.additionalInformation || oasysRiskInfoText
    return {
