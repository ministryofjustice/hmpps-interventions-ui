...
export default class DashboardView {
  ...
  get serviceOutageBannerArgs(): NotificationBannerArgs {
    const text =
      'Please be advised that Refer & Monitor will be offline from 6pm on Friday 21 June until 8am on Monday 24 June, due to planned maintenance being carried out in nDelius.'
