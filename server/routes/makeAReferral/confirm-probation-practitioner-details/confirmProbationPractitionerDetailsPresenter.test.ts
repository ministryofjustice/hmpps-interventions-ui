    ...
    it('returns summary list items when not all the optional elements are returned with value', () => {
      ...
      expect(presenter.summary).toEqual([
        ...
        },
        {
          ...
          valueLink: `<a href="/referrals/6/update-probation-practitioner-email-address" class="govuk-link">Enter email address<span class="govuk-visually-hidden">Enter probation practioner&#39;s email address</span></a>`,
          changeHiddenText: `Change probation practitioner's email address`,
          deleteHiddenText: `Delete probation practitioner's email address`,
        },
        {
          ...
          changeHiddenText: `Change probation practitioner's phone number`,
          deleteHiddenText: `Delete probation practitioner's phone number`,
          valueLink: `<a href="/referrals/6/update-probation-practitioner-phone-number" class="govuk-link">Enter phone number<span class="govuk-visually-hidden">Enter probation practioner&#39;s phone number</span></a>`,
        },
        {
          key: 'PDU (Probation Delivery Unit)',
          lines: ['London'],
        ...
        },
        {
          ...
          changeHiddenText: 'Change probation office',
          deleteHiddenText: `Delete probation office`,
          valueLink: `<a href="/referrals/6/update-probation-practitioner-office" class="govuk-link">Enter probation office<span class="govuk-visually-hidden">Enter probation office</span></a>`,
        },
        {
          key: 'Team phone number',
          lines: [`Not found`],
          ...
          changeHiddenText: 'Change team phone number',
          deleteHiddenText: `Delete team phone number`,
          valueLink: `<a href="/referrals/6/update-probation-practitioner-team-phone-number" class="govuk-link">Enter team phone number<span class="govuk-visually-hidden">Enter team phone number</span></a>`,
          deleteLink: undefined,
        },
      ])
    })
