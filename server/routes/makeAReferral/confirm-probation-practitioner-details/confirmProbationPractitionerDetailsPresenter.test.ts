    ...
    it('returns summary list items when not all the optional elements are returned with value', () => {
      ...
      expect(presenter.summary).toEqual([
        ...
        },
        {
          ...
          valueLink: `<a href="/referrals/6/update-probation-practitioner-email-address" class="govuk-link">Enter email address</a>`,
          changeHiddenText: `probation practitioner's email address`,
          deleteHiddenText: `probation practitioner's email address`,
        },
        {
          ...
          changeHiddenText: `probation practitioner's phone number`,
          deleteHiddenText: `probation practitioner's phone number`,
          valueLink: `<a href="/referrals/6/update-probation-practitioner-phone-number" class="govuk-link">Enter phone number</a>`,
        },
        {
          key: 'PDU (Probation Delivery Unit)',
          lines: ['London'],
        ...
        },
        {
          ...
          changeHiddenText: 'probation office',
          deleteHiddenText: `probation office`,
          valueLink: `<a href="/referrals/6/update-probation-practitioner-office" class="govuk-link">Enter probation office</a>`,
        },
        {
          key: 'Team phone number',
          lines: [`Not found`],
          ...
          changeHiddenText: 'team phone number',
          deleteHiddenText: `team phone number`,
          valueLink: `<a href="/referrals/6/update-probation-practitioner-team-phone-number" class="govuk-link">Enter team phone number</a>`,
          deleteLink: undefined,
        },
      ])
    })
