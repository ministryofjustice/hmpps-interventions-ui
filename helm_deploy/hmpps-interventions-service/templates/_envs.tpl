...
env:
  ...
  - name: COMMUNITYAPI_CONTACTNOTIFICATIONCONTEXT_PROBATIONAREACODE
    value: "{{ .Values.env.COMMUNITYAPI_CONTACTNOTIFICATIONCONTEXT_PROBATIONAREACODE }}"
  ...
  - name: SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_COMMUNITYAPI_CLIENTID
    valueFrom:
      secretKeyRef:
        name: hmpps-auth
        key: interventions-service-client-id.txt

  - name: SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_COMMUNITYAPI_CLIENTSECRET
    valueFrom:
      secretKeyRef:
        name: hmpps-auth
