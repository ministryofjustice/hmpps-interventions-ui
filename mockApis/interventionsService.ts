...
export default class InterventionsServiceMocks {
  ...
  stubAddInterventionNewUser = async (): Promise<unknown> => {
    return this.wiremock.stubFor({
      request: {
        method: 'POST',
        urlPattern: `${this.mockPrefix}/intervention/user`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubGetPrisonerDetails = async (crn: string, responseJson: unknown): Promise<unknown> => {
    return this.wiremock.stubFor({
      request: {
        method: 'GET',
        urlPattern: `${this.mockPrefix}/intervention/prisoner/details/${crn}`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubRecordActionPlanAppointmentAttendance = async (
    ...
    return this.wiremock.stubFor({
      request: {
        method: 'PUT',
        urlPattern: `${this.mockPrefix}/referral/${referralId}/delivery-session-appointments/${appointmentId}/attendance`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubRecordActionPlanAppointmentSessionFeedback = async (
    ...
    return this.wiremock.stubFor({
      request: {
        method: 'PUT',
        urlPattern: `${this.mockPrefix}/referral/${referralId}/delivery-session-appointments/${appointmentId}/session-feedback`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubSubmitActionPlanSessionFeedback = async (
    ...
    return this.wiremock.stubFor({
      request: {
        method: 'POST',
        urlPattern: `${this.mockPrefix}/referral/${referralId}/delivery-session-appointments/${appointmentId}/submit-feedback`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubAmendPrisonEstablishment = async (id: string, responseJson: unknown): Promise<unknown> => {
    return this.wiremock.stubFor({
      request: {
        method: 'POST',
        urlPattern: `${this.mockPrefix}/sent-referral/${id}/amend-prison-establishment`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubAmendProbationPractitionerName = async (id: string, responseJson: unknown): Promise<unknown> => {
    return this.wiremock.stubFor({
      request: {
        method: 'POST',
        urlPattern: `${this.mockPrefix}/sent-referral/${id}/amend-probation-practitioner-name`,
      },
      response: {
        status: 200,
        headers: {
  ...
  stubAmendProbationPractitionerEmail = async (id: string, responseJson: unknown): Promise<unknown> => {
    return this.wiremock.stubFor({
      request: {
        method: 'POST',
        urlPattern: `${this.mockPrefix}/sent-referral/${id}/amend-probation-practitioner-email`,
      },
      response: {
        status: 200,
        headers: {
